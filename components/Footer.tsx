...
export function Footer() {
  return (
    ...
    <a href="mailto:info@zavoratradeaxis.com" className="ml-2 hover:text-secondary">
      info@zavoratradeaxis.com
    </a>

    <span>|</span>

    <a href="mailto:sales@zavoratradeaxis.com" className="ml-2 hover:text-secondary">
      sales@zavoratradeaxis.com
    </a>
  </div>
              </li>
              <li className="flex items-center">
